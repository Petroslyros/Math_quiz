This project is an interactive quiz app that challenges users with a variety of math questions. It is built for Android and it is my first try using Retrofit for API communication.
